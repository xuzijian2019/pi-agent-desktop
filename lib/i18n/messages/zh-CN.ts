...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.commandSide": "提出临时的只读旁聊问题",
    "chat.commandRecap": "总结当前对话上下文",
    "side.command": "打开临时只读侧聊",
    "recap.command": "总结当前对话",
    "side.alreadyOpen": "已有一个侧聊打开。",
    "side.expired": "临时对话已过期，请返回主对话后重新打开。",
    "side.noCommands": "侧聊不支持命令或附件。",
    "recap.cancel": "取消总结",
    "recap.times": "上下文快照 {snapshot} · 生成于 {generated}",
    "side.title": "旁聊",
    "side.readOnly": "只读",
    "side.parentRunning": "主任务仍在运行，工作区文件可能发生变化。",
    "side.return": "返回主对话",
    "side.thinking": "思考中…",
    "side.placeholder": "继续提问…",
    "side.noAttachments": "旁聊和回顾不支持附件。",
    "side.needsSession": "请先发送一条主对话消息，再打开旁聊或回顾。",
    "side.usage": "用法：/side <问题>（或 /btw <问题>）",
    "recap.usage": "用法：/recap",
    "recap.busy": "正在生成回顾。",
    "recap.ready": "回顾已生成",
    "recap.title": "对话回顾",
    ...
    "chat.commandModel": "选择或切换模型",
    "chat.commandThinking": "设置思考级别",
    "chat.commandNew": "新建会话",
    "chat.commandResume": "查找并恢复会话",
    "chat.commandTree": "浏览会话分支",
    "chat.commandFork": "从历史消息创建独立会话",
    "chat.commandExport": "打开会话 HTML 导出",
    "chat.commandSettings": "打开应用设置",
    "chat.commandLogin": "配置服务商登录",
    "chat.commandLogout": "管理服务商退出登录",
    "chat.commandTrust": "查看项目信任设置",
    "chat.commandHotkeys": "键盘快捷键",
    "chat.commandList": "命令",
    "chat.commandNavigation": "↑↓ 选择 · Enter 确认 · Tab 补全 · Esc 关闭",
    "chat.commandTextOnly": "命令仅支持文本，请先移除附件。",
    "chat.commandWait": "请等当前任务结束后再使用此命令。",
    "chat.commandNoArgs": "/{command} 会打开对应操作，不接受参数。",
    "chat.commandUnavailable": "当前视图无法使用此命令。",
    "chat.commandNeedsSession": "请先打开已有会话。",
    "chat.commandModelUsage": "使用 /model 选择模型，或输入 /model 服务商/模型ID。",
    "chat.commandThinkingUsage": "使用 /thinking 选择此模型支持的思考级别。",
    "chat.imageMessage": "图片消息",
    "chat.noForkMessages": "当前会话没有可用于创建独立会话的用户消息。",
    "chat.forkChoose": "选择一条用户消息，新会话将保留它之前的上下文。",
    "chat.keysSelect": "选择命令",
    "chat.keysComplete": "补全命令",
    "chat.keysSubmit": "确认命令或发送消息",
    "chat.keysNewline": "换行",
    "chat.keysSteer": "引导正在运行的任务",
    "chat.keysEscape": "关闭菜单；没有菜单时停止运行中的任务",
    "chat.statsMessages": "消息数",
    "chat.statsTools": "工具调用",
    "chat.statsTokens": "总 token",
    "chat.statsCost": "费用",
    "chat.messageLabel": "消息",
    "chat.sessionUsage": "会话用量",
    "chat.usageTokens": "token",
    "chat.statsInput": "输入 token",
    "chat.statsOutput": "输出 token",
    "chat.statsCacheRead": "缓存读取 token",
    "chat.statsCacheWrite": "缓存写入 token",
