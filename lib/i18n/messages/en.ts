...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.browserNotificationsDescription": "Show a notification when background work finishes while this tab is not focused. Unread indicators in the sidebar work either way.",
    "settings.browserNotificationsDenied": "Notifications are {permission} in this browser. Unread indicators remain available.",
