...
export const zhTWLocale: LocalePlugin = {
  ...
  label: "繁體中文",
  messages: {
    // Fork-only workbench strings fall back to English until translated.
    ...enLocale.messages,
    "sidebar.cwdMissing": "專案目錄已不存在",
    "common.ok": "確定",
    "common.language": "語言",
    "common.models": "模型",
    "common.skills": "技能",
    ...
    "settings.browserNotificationsDescription": "當此分頁不在前景時，背景工作完成後顯示通知。側欄的未讀標記不受影響。",
    "settings.browserNotificationsDenied": "此瀏覽器的通知權限為 {permission}。未讀標記仍可使用。",
    ...
    "contextPanel.openExternally": "用預設應用程式開啟",
    "contextPanel.revealInFinder": "在 Finder 中顯示",
    ...
    "appSettings.taglineWeb": "{product} 將 pi 編碼智慧體的全部能力封進一個優雅的介面。",
    ...
    "appSettings.autoTitle": "自動為新工作階段命名",
    "appSettings.autoTitleHint": "根據第一則訊息產生標題；可用「產生標題」依整個工作階段重寫。",
